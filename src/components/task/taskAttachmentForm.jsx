...
// import TaskAttachmentTable from "./taskAttachmentTable";
    ...
    <section>
      ...
      >
        <div className="flex flex-col gap-2 w-1/5">
          ...
          {/* <input
            type="file"
            className={`${poppins.className} flex flex-col gap-2 w-1/5`}
        ...
        <div className="flex flex-col gap-2 w-1/5" style={{ width: "100%" }}>
